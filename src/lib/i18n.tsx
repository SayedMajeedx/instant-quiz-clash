...
const ar: Dict = {
  ...
  "quizzes.emptyBody": "أنشئ أول كويز لك واستضفه في أقل من دقيقة.",
  ...
  "editor.hostThis": "استضف هذا الكويز",
  ...
  "aiGen.failed": "تعذر إنشاء هذا الكويز، يرجى تجربة موضوع آخر",

  "nav.browse": "مكتبة الكويزات",
  "browse.title": "مكتبة الكويزات الجاهزة",
  "browse.sub": "اختر كويزاً جاهزاً للعب مباشرة، أو انسخه إلى حسابك للتعديل عليه.",
  ...
  "browse.cloned": "تمت إضافة الكويز إلى مكتبتك!",
  "browse.error": "تعذر نسخ الكويز، يرجى المحاولة مرة أخرى",
  "browse.empty": "لا توجد كويزات في هذا التصنيف حالياً.",
  "browse.ctaTitle": "تبحث عن كويزات جاهزة للعب مباشرة؟",
  "browse.ctaSub": "استكشف مكتبتنا المجانية الشاملة في التاريخ، العلوم، الرياضة، والثقافة العامة.",
  "browse.ctaBtn": "تصفح مكتبة الكويزات",

  "preview.back": "← العودة للمكتبة",
  "preview.title": "معاينة الكويز",
