...
AS $$
  SELECT q.id, q.quiz_id, q.question_text, q.options, q.time_limit_seconds, q.order_index, q.image_url, q.question_type, q.explanation, q.difficulty, q.subcategory, q.tags, q.source, q.external_id
